...
if( ! function_exists( 'techup_footer_start' ) ):
	function techup_footer_start(){
		$footer_sticky = get_theme_mod( 'techup_footer_sticky_opt', true ); ?>
		    ...
		    <footer class="footer footer-one" id="foot-wdgt" style="background-image:url(<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/img.png'); ?>)">
		...
		<div class="foot-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <?php bloginfo( 'name' ); ?> 						
						<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'smart-techup' ) ); ?>" class="imprint">
						<?php
							/* translators: %s: WordPress */
						esc_url( __( 'Proudly Powered By %s', 'smart-techup' ), 'WordPress' );
						?>
                    </div>
                </div>
            </div>
